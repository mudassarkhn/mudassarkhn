...
|:--|:--|:--|
| 🧠 [**AI Strategy Generator**](https://github.com/mudassarkhn) | 7-stage AI business strategy pipeline with Gemini & GPT via LangChain | `Python` `LangChain` `FastAPI` `Gemini` `GPT` |
| 🧑‍💼 [**HR Attendance Assistant Bot**](https://github.com/mudassarkhn) | Natural language HR data querying — attendance, leave & performance insights | `SQL` `LLM` `LangChain` `Groq` `Qdrant` |
...
*"AI isn't just about models — it's about building practical solutions that reduce manual effort, solve real problems, and scale effectively."*
